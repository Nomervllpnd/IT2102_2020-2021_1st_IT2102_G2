...
public class ViewManager {
	...
	private void createScoreSubScene() {
		...
		Label score1 = new Label("Monster 1		  100");
		Label score2 = new Label("Monster 2		  100");
		Label score3 = new Label("Monster 3		  100");
	...
	private void createCreditsSubScene() {
		...
		Label credit0 = new Label("Nomer Villapando");
		Label credit1 = new Label("Chrisle Aubrey Malabanan");
		Label credit2 = new Label("Jr. Gimongala");
		Label credit3 = new Label("Alexander Palapan");
		
		credit0.setFont(Font.font("Verdana",20));
		credit1.setFont(Font.font("Verdana",20));
		credit2.setFont(Font.font("Verdana",20));
		credit3.setFont(Font.font("Verdana",20));
		
		
		
				
				
		VBox creditsBox = new VBox(10, credit0,credit1,credit2,credit3 );
	...
	private void createLogo() {
		Image logoImage = new Image("view/resources/monster2.png", 500, 100, false, false);
